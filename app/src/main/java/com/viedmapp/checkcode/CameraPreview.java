...
class CameraPreview extends View implements IViewFinder {
    private static final String TAG = "ViewFinderView";

    private Rect mFramingRect;

    private static final float PORTRAIT_WIDTH_RATIO = 6f/8;
    private static final float PORTRAIT_WIDTH_HEIGHT_RATIO = 0.7f;

    private static final float LANDSCAPE_HEIGHT_RATIO = 3f/8;
    ...
    private final int mDefaultMaskColor = getResources().getColor(R.color.gray_50);
    ...
    private void init() {
        ...
        mBorderPaint.setStrokeWidth(25);
